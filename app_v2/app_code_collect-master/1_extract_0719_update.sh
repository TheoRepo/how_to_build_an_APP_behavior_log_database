...
(
    ...
    type_index,
    behavior_index
    from ${regexp_table} where the_date='2021-07-19' and version_no='${version_no}'
...
if [[ $? != 0 ]];then
    msg="定时调度【${version_no}版本规则对最近15天的短文本的APP行为信息抽取】1_extract_0719_update.sh脚本跑数失败了55555"
